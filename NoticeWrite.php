...
<section class="contact spad">
    <div class="container">
        <form name="nse" action="NoticeWrite_action.php" method="post">
            <table class="table">
                <tr>
                    <td height=20 align=center bgcolor=#ccc><font color=white size="6">공지사항 작성하기</font></td>
                </tr>
                <tr>
                    <td bgcolor=white>
                        <table class="table">
            ...
            <hr/>
            <input type="button" onclick="submitContents(this)" class="btn btn-outline-dark pull-right" value="작성하기">
        </form>
    </div>
</section>
<!-- Contact Section End -->
