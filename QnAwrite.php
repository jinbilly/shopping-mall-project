        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb__links">
                    ...
                    <a href="noticeboard.php"><i class="fa fa-comment"></i>1:1 board</a>
                    <span>Write</span>
                </div>
            </div>
        </div>
...
<section class="contact spad">
    <div class="container">
        <form method="post" action="QnAwrite_action.php">
            <table class="table">
                <tr>
                    <td height=20 align=center bgcolor=#ccc><font color=white size="6">작성하기</font></td>
                </tr>
                <tr>
                    <td bgcolor=white>
                        <table class="table">
                            ...
                            <tr>
                                <td>제목</td>
                                <td><input class="form-control py-4" type=text name=title size=60></td>
                            </tr>
            ...
            <hr/>
            <input type="submit" onclick="submitContents(this)" class="btn btn-outline-dark pull-right" value="작성하기" />
        </form>
    </div>
</section>
<!-- Contact Section End -->
