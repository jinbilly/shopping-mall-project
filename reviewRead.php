...
//리뷰 정보 쿼리로 가져오기
$index = $_GET["index"];
$search_query = "SELECT * FROM item_review WHERE reviewSeq='$index'";
            ...
            <div class="col-xl-6 col-lg-7">
                <nav class="header__menu">
                    <ul>
                        ...
                        <?php
                        if (isset($_SESSION["userId"]) && $_SESSION["userId"] == "root") { ?>
                            <li><a href="AdminPage.php">Administer page</a></li>
...
<section class="contact spad">
    <div class="container">
        <form method="post" action="write_ action.php">
            <table class="table">
                <tr>
                    <td height=20 align=center bgcolor=#ccc><font color=white size="6">내가 작성한 리뷰</font></td>
                </tr>
                <tr>
                    <td bgcolor=white>
                        <table class="table">
            ...
            <hr/>
                ...
                <button type="button" class="btn btn-info pull-right" onclick="location.href='myPage.php?index=3'">
                    목록
                </button>
                ...
                <input type="button" class="btn btn-outline-dark pull-right" value="삭제하기"
                       onclick="location.href='review_delete_action.php?index=<?php echo $index; ?>'"/>

                <input type="button" class="btn btn-outline-dark pull-right" value="수정하기"
                       onclick="location.href='review_modify.php?index=<?php echo $index; ?>'"/>
