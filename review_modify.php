            ...
            <div class="col-xl-6 col-lg-7">
                <nav class="header__menu">
                    <ul>
                        ...
                        <li class="active"><a href="noticeboard.php">Noticeboard</a></li>
...
if (isset($_GET["index"])) {
    ...
    $reviewSeq=$_GET["index"];
    $search_query="SELECT * FROM item_review WHERE reviewSeq=$reviewSeq";
...
<section class="contact spad">
    <div class="container">
        <form method="post" action="review_modify_action.php">
            <table class="table">
                <tr>
                    <td height=20 align=center bgcolor=#ccc><font color=white size="6">수정페이지</font></td>
                </tr>
                <tr>
                    <td bgcolor=white>
                        <table class="table">
                            ...
                            <tr>
                                <td>상품명</td>
                                <td>
                                    <input class="form-control py-4" type=text name=itemName size=60
                            ...
                            <tr>
                                <td>제목</td>
                                <td>
                                    <input class="form-control py-4" type=text name=title size=60
                                           value=" <?php echo $result[4]; ?>">
                                </td>
                            </tr>

                            <input type="hidden" name="reviewSeq" value="<?php echo $reviewSeq; ?>" >
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="content" id="ir1" class="nse_content"
                                              style="width: 100%"> <?php echo $result[5]; ?></textarea>
            ...
            <hr/>
            <input type="submit" class="btn btn-outline-dark pull-right" value="수정하기" onclick="submitContents(this)"/>
        </form>
    </div>
</section>
<!-- Contact Section End -->
